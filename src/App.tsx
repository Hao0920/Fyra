        ...
        <main className="space-y-6">
          ...
          <div className="card overflow-hidden p-6">
            <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
              <div>
                <p className="text-xs uppercase tracking-[0.3em] text-slate-400">账户概览</p>
              ...
              <div className="space-y-5">
                <div className="grid gap-4 sm:grid-cols-3">
                  {[
                    ...
                    <div key={item.title} className="rounded-[2rem] border border-slate-800/90 bg-slate-950/80 p-6">
                ...
                <div className="rounded-[2.5rem] border border-slate-800/90 bg-slate-900/80 p-6 shadow-inner">
