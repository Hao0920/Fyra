...
function App() {
  return (
    <div className="min-h-screen bg-slate-950 px-4 py-6 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-[1900px] gap-6 xl:grid-cols-[96px_minmax(0,1fr)_380px]">
                    ...
                    <div className="rounded-[2.5rem] border border-slate-800/90 bg-slate-900/80 p-5 shadow-inner">
                      <div className="mb-5 flex items-center justify-between gap-4">
                        <div>
                          ...
                          <h3 className="mt-2 text-xl font-semibold text-slate-100">月度消费趋势</h3>
                        </div>
                      ...
                      <div className="h-[300px] rounded-[2rem] bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-5">
